...
const HomePage = () => {
  ...
  const images = ['https://d1csarkz8obe9u.cloudfront.net/posterpreviews/concert-band-instagram-post-template-design-2313896398b4a525c99a560923d17f61_screen.jpg?ts=1567524012', 
  ...
  return (
    <div>
      <div className="video-a">
        ...
        <h1 style={{ fontFamily: 'cursive', fontSize:'4rem'}} className="centered-text">Movement. Music. Love.
          <center>
      ...
      <div style={{ marginTop:'150px',marginBottom:'150px'}} className="card-container">
       ...
       <center><div className="image-row">
          <img style={{ marginRight:'140px', maxWidth: '100%' }} src="https://cdn.pixabay.com/photo/2023/06/24/18/41/special-offer-8085855_640.png" alt="" />
          <img style={{ marginRight:'140px', maxWidth: '100%' }} src="https://cdn-icons-png.freepik.com/512/2558/2558957.png" alt="" />
          <img style={{ maxWidth: '100%' }} src="https://cdn-icons-png.flaticon.com/512/1517/1517690.png" alt="" />
        </div></center> 
